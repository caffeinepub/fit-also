...
export type TranslationKey =
  // Navigation
  | 'nav.home' | 'nav.catalog' | 'nav.tailors' | 'nav.cart' | 'nav.dashboard' | 'nav.admin' | 'nav.login' | 'nav.logout' | 'nav.loggingIn'
  // Hero
  | 'hero.title' | 'hero.subtitle' | 'hero.cta' | 'hero.secondary'
  // Categories
  | 'cat.shirts' | 'cat.kurtas' | 'cat.suits' | 'cat.sherwanis' | 'cat.trousers' | 'cat.lehengas' | 'cat.sareeBlouses' | 'cat.anarkalis'
  // Catalog
  | 'catalog.title' | 'catalog.search' | 'catalog.filter' | 'catalog.allCategories' | 'catalog.noResults' | 'catalog.viewDetails' | 'catalog.by'
  // Listing Detail
  | 'listing.customize' | 'listing.neckStyle' | 'listing.sleeveStyle' | 'listing.fabric' | 'listing.color' | 'listing.workType' | 'listing.addToCart' | 'listing.price' | 'listing.tailorProfile' | 'listing.estimatedDelivery' | 'listing.basePrice'
  // Customization Options
  | 'neck.round' | 'neck.vNeck' | 'neck.mandarin' | 'neck.boat' | 'neck.square' | 'neck.sweetheart'
  | 'sleeve.full' | 'sleeve.half' | 'sleeve.sleeveless' | 'sleeve.threequarter' | 'sleeve.cap'
  | 'fabric.cotton' | 'fabric.silk' | 'fabric.linen' | 'fabric.chiffon' | 'fabric.georgette' | 'fabric.velvet' | 'fabric.brocade' | 'fabric.crepe'
  | 'color.ivory' | 'color.red' | 'color.navy' | 'color.emerald' | 'color.gold' | 'color.burgundy' | 'color.blush' | 'color.black'
  | 'work.plain' | 'work.embroidery' | 'work.zari' | 'work.sequin' | 'work.mirror' | 'work.block'
  // Cart
  | 'cart.title' | 'cart.empty' | 'cart.checkout' | 'cart.remove' | 'cart.total' | 'cart.customization'
  // Checkout
  | 'checkout.title' | 'checkout.review' | 'checkout.measurements' | 'checkout.confirm' | 'checkout.selectMeasurement' | 'checkout.placeOrder' | 'checkout.success' | 'checkout.orderPlaced'
  // Orders
  | 'orders.title' | 'orders.id' | 'orders.date' | 'orders.tailor' | 'orders.status' | 'orders.amount' | 'orders.viewDetail' | 'orders.noOrders'
  | 'status.pending' | 'status.confirmed' | 'status.inTailoring' | 'status.shipped' | 'status.delivered' | 'status.cancelled'
  // Dashboard
  | 'dash.welcome' | 'dash.activeOrders' | 'dash.orderHistory' | 'dash.measurements' | 'dash.loyalty' | 'dash.profile' | 'dash.myListings' | 'dash.shopProfile' | 'dash.earnings' | 'dash.incomingOrders'
  // Measurements
  | 'meas.title' | 'meas.add' | 'meas.edit' | 'meas.delete' | 'meas.profileName' | 'meas.chest' | 'meas.waist' | 'meas.hips' | 'meas.shoulder' | 'meas.sleeve' | 'meas.inseam' | 'meas.neck' | 'meas.height' | 'meas.save' | 'meas.unit'
  // Loyalty
  | 'loyalty.points' | 'loyalty.balance' | 'loyalty.history' | 'loyalty.earned' | 'loyalty.order' | 'loyalty.date'
  // Tailor
  | 'tailor.directory' | 'tailor.shopName' | 'tailor.city' | 'tailor.specialties' | 'tailor.bio' | 'tailor.portfolio' | 'tailor.turnaround' | 'tailor.basePricing' | 'tailor.onboard' | 'tailor.pendingApproval' | 'tailor.contact' | 'tailor.viewProfile'
  // Admin
  | 'admin.title' | 'admin.totalOrders' | 'admin.totalRevenue' | 'admin.activeTailors' | 'admin.customers' | 'admin.recentOrders' | 'admin.manageTailors' | 'admin.approve' | 'admin.reject' | 'admin.suspend'
  // Auth
  | 'auth.selectRole' | 'auth.customer' | 'auth.tailor' | 'auth.admin' | 'auth.completeProfile' | 'auth.name' | 'auth.phone' | 'auth.language' | 'auth.save' | 'auth.accessDenied' | 'auth.goHome'
  // Common
  | 'common.save' | 'common.cancel' | 'common.edit' | 'common.delete' | 'common.loading' | 'common.error' | 'common.success' | 'common.back' | 'common.viewAll' | 'common.days' | 'common.inr' | 'common.search';
...
export const translations: Translations = {
  en: {
    ...
    'hero.subtitle': 'Discover India\'s finest tailors. Custom garments made to your exact measurements.',
    ...
    'checkout.orderPlaced': 'Your order has been placed. The tailor will confirm shortly.',
    // Orders
