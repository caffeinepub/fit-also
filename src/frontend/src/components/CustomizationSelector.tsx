...
export function CustomizationSelector({
  ...
  const update = <K extends keyof CustomizationOptions>(
    key: K,
    val: CustomizationOptions[K],
  ) => {
  ...
  return (
    <div className="grid gap-4">
      <div className="grid gap-1.5">
        ...
        <Select
          value={value.neckStyle}
          onValueChange={(v) => update("neckStyle", v as NeckStyle)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="grid gap-1.5">
        ...
        <Select
          value={value.sleeveStyle}
          onValueChange={(v) => update("sleeveStyle", v as SleeveStyle)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="grid gap-1.5">
        ...
        <Select
          ...
          onValueChange={(v) => update("fabricType", v as FabricType)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="grid gap-1.5">
        ...
        <Select
          ...
          onValueChange={(v) => update("colorPattern", v as ColorPattern)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="grid gap-1.5">
        ...
        <Select
          ...
          onValueChange={(v) => update("workType", v as WorkType)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
