...
import { Scissors, ShieldCheck, User, X } from "lucide-react";
  ...
  const roles = [
    {
      ...
      icon: User,
      desc: "Browse and order custom garments",
    },
    {
      id: "tailor" as const,
      label: t("auth.tailor"),
      icon: Scissors,
      desc: "List your services and manage orders",
    },
    {
      id: "admin" as const,
      label: t("auth.admin"),
    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && handleClose()}>
      ...
      >
        <DialogHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <DialogDescription>
                {step === "role"
                  ? "Choose how you want to use Fit Also"
        ...
        {step === "role" ? (
          ...
          <div
            className="grid gap-4 py-2 max-h-[60vh] overflow-y-auto pb-[300px]"
            style={{ scrollMarginBottom: "200px" }}
          >
            <div
