  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <LuxuryButton variant="outline" size="sm" onClick={() => { setEditingProfile(null); setShowForm(true); }}>
      ...
      {profiles.length === 0 ? (
        <LuxuryCard className="p-8 text-center">
          ...
          <p className="text-muted-foreground text-sm">No measurement profiles yet. Add one to get started.</p>
        </LuxuryCard>
      ) : (
            ...
            <LuxuryCard key={profile.id} className="p-4">
              ...
              <div className="grid grid-cols-4 gap-2 text-xs">
                {[
                  ...
                  <div key={m.label} className="text-center p-1.5 bg-muted rounded-md">
      ...
      <Dialog open={showForm} onOpenChange={open => { if (!open) { setShowForm(false); setEditingProfile(null); } }}>
