...
const DEMO_LISTINGS: ProductListing[] = [
  {
    ...
    description:
      "Exquisite sherwani crafted from premium brocade with intricate zari embroidery. Perfect for weddings and grand occasions.",
    basePrice: 8500,
    estimatedDays: 21,
  ...
  },
  {
    ...
    description:
      "Stunning bridal lehenga with hand-crafted mirror work and delicate embroidery. A masterpiece for your special day.",
    basePrice: 12000,
    estimatedDays: 28,
  ...
  },
  {
    ...
    description:
      "Tailored linen suit for the modern professional. Clean lines, perfect fit, timeless elegance.",
    basePrice: 4500,
    estimatedDays: 12,
  ...
  },
  {
    ...
    description:
      "Luxurious silk kurta with subtle embroidery at the collar and cuffs. Ideal for festive occasions.",
    basePrice: 2800,
    estimatedDays: 10,
  ...
  },
  {
    ...
    description:
      "Flowing georgette anarkali with intricate thread embroidery. Graceful and elegant for any occasion.",
    basePrice: 5500,
    estimatedDays: 18,
  ...
  },
  {
    ...
    description:
      "Crisp cotton oxford shirt with a perfect collar and precise tailoring. A wardrobe essential.",
    basePrice: 1800,
    estimatedDays: 7,
...
export function useCatalog() {
  ...
  const getListing = useCallback(
    (id: string): ProductListing | undefined => {
  ...
  const createListing = useCallback(
    (listing: Omit<ProductListing, "id" | "createdAt">) => {
  ...
  const updateListing = useCallback(
    (id: string, updates: Partial<ProductListing>) => {
      saveListings(
        listings.map((l) => (l.id === id ? { ...l, ...updates } : l)),
      );
    },
    [listings, saveListings],
  );
  ...
  const filterListings = useCallback(
    (category?: GarmentCategory | "", search?: string): ProductListing[] => {
